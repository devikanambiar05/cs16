...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#191816]">
      {/* ── Navbar ── */}
      {!isAdmin && (
        <header className="sticky top-0 z-50 shadow-sm bg-white dark:bg-[#22211e] border-b border-slate-200 dark:border-slate-800">
                    ...
                    <div className="relative">
                      ...
                      {profileOpen && (
                        <>
                          ...
                          <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-slate-200 rounded-xl shadow-lg py-1 transition-all z-50">
